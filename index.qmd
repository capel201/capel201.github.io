...
author: Jérémie Drouin<br>Camille Pelletier
institute: Faculté des sciences sociales
lang: fr
from: markdown+emoji
format:
  revealjs:
    ...
    footer: "[CAPP](https://www.capp.ulaval.ca)"
    transition: slide
...
- Partager le code [(GitHub, GitLab, etc.)](https://github.com/clessn/beyond_multiple_choices)
